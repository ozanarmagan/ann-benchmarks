...
class typesenseVamana(BaseANN):
    def __init__(self, metric, method_param):
        print("Initializing Typesense Vamana R32 Re Method Parameters:", method_param)
        self.metric = {"angular": "cosine", "euclidean": "l2"}[metric]
        self.name = 'typesenseVamana'
    ...
    def fit(self, X):
        ...
        schema = {
            ...
            "fields": [
                {"name": '_id', "type": "int32"},
                {"name": "vector", "type": "float[]", "num_dim": X.shape[1], "vamana_params": { "R": self.method_param["R"], "L_build": self.method_param["L_build"] } },
            ]
        }
        try:
